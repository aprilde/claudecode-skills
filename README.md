...
Each skill lives in its own folder under skills/, with a SKILL.md (the skill itself) and a README.md explaining what it does and how to use it.
...
SkillWhat it doesnetnographyRuns a guided netnographic study of an online community — from research question to an evidence-grounded findings report — following Kozinets's five-phase framework, with a human checkpoint at every phase.
...
Browse to the skill's folder and read its README.md.
Add the skill to your Claude setup (e.g. drop the SKILL.md into your skills directory, or install it however your Claude environment loads skills).
Invoke it as described in that skill's README.
